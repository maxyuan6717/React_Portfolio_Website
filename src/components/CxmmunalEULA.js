...
export const CxmmunalEULA = () => {
  return (
    <Container>
      <Title>Cxmmunal's End User License Agreement</Title>
      <div>Last updated August 14, 2023</div>
      <br />
      <div>
        Cxmmunal is licensed to You (End-User) by Cxmmunal, located at 485
        ...
        that You accept this License Agreement. App Store is referred to in this
        ...
        as warranty, liability, maintenance and support thereof. Cxmmunal, not
        ...
        ("Usage Rules"). Cxmmunal acknowledges that it had the opportunity to
        review the Usage Rules and this License Agreement is not conflicting
        with them.
        <br />
        <br />
        Cxmmunal when purchased or downloaded through the Services, is licensed
        to You for use only under the terms of this License Agreement. The
        Licensor reserves all rights not expressly granted to You. Cxmmunal is
      ...
      <div>
        Cxmmunal ("Licensed Application") is a piece of software created to
        revive communal spaces in cities — and customized for iOS mobile devices
        ("Devices"). It is used to create, find, facilitate, and reflect on
        social events.
      </div>
      <div>
        Furthermore, it is used to see location of friends and communicate with
        other users.
      </div>
      <div>
      ...
      <div>
        4.2 Cxmmunal and the End-User acknowledge that the Services have no
      ...
      <div>
        ...
        <a
          href="https://maxyuan.io/cxmmunal-privacy"
          target="_blank"
          rel="noopener noreferrer"
        >
          https://maxyuan.io/cxmmunal-privacy
        </a>
        .
      </div>
      <div>
      ...
      <div>
        ...
        outside of Cxmmunal's sphere of influence that affect the executability
        of the Licensed Application.
      </div>
      <div>
        9.3 You are required to inspect the Licensed Application immediately
        after installing it and notify Cxmmunal about issues discovered without
        ...
        emailed within a period of 14 days after discovery.
      </div>
      <div>
        9.4 If we confirm that the Licensed Application is defective, Cxmmunal
      ...
      <div>
        <b>10. PRODUCT CLAIMS</b>
      </div>

      <div>
        Cxmmunal and the End-User acknowledge that Cxmmunal, and not the
      ...
      <div>Benjamin Chen</div>

      <div>benisin5@gmail.com</div>
      ...
      <div>
        The license is valid until terminated by Cxmmunal or by You. Your rights
        under this license will terminate automatically and without notice from
        Cxmmunal if You fail to adhere to any term(s) of this license. Upon
      ...
      <div>
        <b>14. THIRD-PARTY TERMS OF AGREEMENTS AND BENEFICIARY</b>
      </div>

      <div>
        Cxmmunal represents and warrants that Cxmmunal will comply with
      ...
      <div>
        Cxmmunal and the End-User acknowledge that, in the event of any
        ...
        party's intellectual property rights, Cxmmunal, and not the Services,
      ...
      <div>
        <b>16. APPLICABLE LAW</b>
      </div>
      <div>
        This License Agreement is governed by the laws of the Commonwealth of
        Massachusetts excluding its conflicts of law rules.
      </div>
